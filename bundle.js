...
/***/ function(module, exports, __webpack_require__) {
	...
	var visits = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://fathomless-island-31867.herokuapp.com/'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var entryToVisits = function entryToVisits() {
	  $(".entry-page").hide(800);
	  $(".visit-page").show(800);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showShopsPage = function showShopsPage() {
	  $('.shops-page').show(800);
	};

	var showVisitsPage = function showVisitsPage() {
	  $('.visits-page').show(800);
	};

	var leaveShopsPage = function leaveShopsPage() {
	  $('shops-list').clear();
	};

	module.exports = {
	  hidePages: hidePages,
	  showShopsPage: showShopsPage,
	  showVisitsPage: showVisitsPage,
	  leaveShopsPage: leaveShopsPage
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleShopButtonClick = function handleShopButtonClick(event) {
	  event.preventDefault();
	  router.hidePages();
	  router.showShopsPage();
	  api.getShops().done(ui.displayShops).fail(function (error) {
	    debugger;
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayShops = function displayShops(data) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function visitLikeOrDislikeClick(event) {
	  var selectedShopId = parseInt(event.target.parentElement.dataset.shop);
	  var theyLikedIt = true;
	  var userId = parseInt(app.user.id);
	  api.createVisit(userId, selectedShopId, theyLikedIt).done(function (data) {
	...
	var handleVisitsButtonClick = function handleVisitsButtonClick(event) {
	  event.preventDefault();
	  router.hidePages();
	  router.showVisitsPage();
	  api.getVisits().done(ui.displayVisits).fail(function (error) {
	    $('.nav-messages').text(error);
	  });
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  addNewVisitToShops: addNewVisitToShops,
	  addLikeButtonsToShops: addLikeButtonsToShops,
	  addDislikeButtonsToShops: addDislikeButtonsToShops
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayVisits = function displayVisits(data) {
	  event.preventDefault();
	...
	var showLikeAndDislikeButtons = function showLikeAndDislikeButtons() {
	  $('like-button').show(300);
	  $('dislike-button').show(300);
	};

	var likeButtonClickedMessage = function likeButtonClickedMessage() {
	  $('nav-messages').text('You liked this!', 600);
	};

	var newVisitButtonClickedMessage = function newVisitButtonClickedMessage() {
	  $('nav-messages').text('You created a new visit!', 600);
	};

	var dislikeButtonClickedMessage = function dislikeButtonClickedMessage() {
	  $('nav-messages').text('You disliked this :/');
	};

	module.exports = {
	  showLikeAndDislikeButtons: showLikeAndDislikeButtons,
	  likeButtonClickedMessage: likeButtonClickedMessage,
	  newVisitButtonClickedMessage: newVisitButtonClickedMessage,
	  dislikeButtonClickedMessage: dislikeButtonClickedMessage
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
